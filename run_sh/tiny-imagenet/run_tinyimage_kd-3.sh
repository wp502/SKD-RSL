...
python train_student.py --epochs 100 --lr_decay_epochs 30,60,90 --dataset tiny_imagenet --num_class 200 --batch_size 128 --learning_rate 0.1 --lr_decay_rate 0.1 --model_t ResNet34_another --model_s ShuffleV2_img --path_t ./save/base/tiny_imagenet/ResNet34_another_tiny_imagenet_base/ResNet34_another_teacher_90_checkpoint_64.59.pth.tar --distill kd -a 1 -b 1 -r 1 --kd_T 4 -t contrast-3-04_01

# 5
# VGG11_BN_IMG - MobileNetV2_img
python train_student.py --epochs 100 --lr_decay_epochs 30,60,90 --dataset tiny_imagenet --num_class 200 --batch_size 128 --learning_rate 0.1 --lr_decay_rate 0.1 --model_t VGG11_BN_IMG --model_s MobileNetV2_img --path_t ./save/base/tiny_imagenet/VGG11_BN_IMG_tiny_imagenet_base/VGG11_BN_IMG_teacher_best.pth.tar --distill kd -a 1 -b 1 -r 1 --kd_T 4 -t contrast-3-05_01