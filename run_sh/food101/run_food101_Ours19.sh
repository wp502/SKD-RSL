...
basicR101R34='train_ours_111.py --dataset food101 --num_class 101 --batch_size 64 --model_s ResNet34_another --model_t ResNet101_another --path_t ./save/base/food101/ResNet101_another_food101_base/ResNet101_another_teacher_best.pth.tar --method 1 --in_method inAuxCF_logitsNToAE_OnlyOne-5 --fusion_method AUXCF --feedback_time 0 --learning_rate 0.1 --lr_decay_rate 0.1 --add_param_groups_method all --self_method_t bi_directional --self_method_s bi_directional --epochs 100 --lr_decay_epochs 30,60,90 --scheduler_method MultiStepLR --in_criterion KL_softmax --blocks_amount_t 4 --blocks_amount_s 4 --aux_method_t Basic --aux_method_s Basic'
...
basicV13V8='train_ours_111.py --dataset food101 --num_class 101 --batch_size 64 --model_s VGG8_BN_IMG --model_t VGG13_BN_IMG --path_t ./save/base/food101/VGG13_BN_IMG_food101_base/VGG13_BN_IMG_teacher_best.pth.tar --method 1 --in_method inAuxCF_logitsNToAE_OnlyOne-5 --fusion_method AUXCF --feedback_time 0 --learning_rate 0.1 --lr_decay_rate 0.1 --add_param_groups_method all --self_method_t bi_directional --self_method_s bi_directional --epochs 100 --lr_decay_epochs 30,60,90 --scheduler_method MultiStepLR --in_criterion KL_softmax --blocks_amount_t 4 --blocks_amount_s 4 --aux_method_t Basic --aux_method_s Basic'
...
basicR34ShuV2='train_ours_111.py --dataset food101 --num_class 101 --batch_size 64 --model_s ShuffleV2_img --model_t ResNet34_another --path_t ./save/base/food101/ResNet34_another_food101_base/ResNet34_another_teacher_best.pth.tar --method 1 --in_method inAuxCF_logitsNToAE_OnlyOne-5 --fusion_method AUXCF --feedback_time 0 --learning_rate 0.1 --lr_decay_rate 0.1 --add_param_groups_method all --self_method_t bi_directional --self_method_s bi_directional --epochs 100 --lr_decay_epochs 30,60,90 --scheduler_method MultiStepLR --in_criterion KL_softmax --blocks_amount_t 4 --blocks_amount_s 4 --aux_method_t Basic --aux_method_s Basic'
...
basicV11MobV2='train_ours_111.py --dataset food101 --num_class 101 --batch_size 64 --model_s MobileNetV2_img --model_t VGG11_BN_IMG --path_t ./save/base/food101/VGG11_BN_IMG_food101_base/VGG11_BN_IMG_teacher_best.pth.tar --method 1 --in_method inAuxCF_logitsNToAE_OnlyOne-5 --fusion_method AUXCF --feedback_time 0 --learning_rate 0.1 --lr_decay_rate 0.1 --add_param_groups_method all --self_method_t bi_directional --self_method_s bi_directional --epochs 100 --lr_decay_epochs 30,60,90 --scheduler_method MultiStepLR --in_criterion KL_softmax --blocks_amount_t 4 --blocks_amount_s 4 --aux_method_t Basic --aux_method_s Basic'
