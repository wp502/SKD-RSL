...
python train_student.py --epochs 100 --lr_decay_epochs 30,60,90 --dataset food101 --num_class 101 --batch_size 64 --learning_rate 0.1 --lr_decay_rate 0.1 --model_t ResNet34_another --model_s ShuffleV2_img --path_t ./save/base/food101/ResNet34_another_food101_base/ResNet34_another_teacher_best.pth.tar --distill fitnet -a 1 -b 1 -r 1 --kd_T 3 -t contrast-4-04_01

# 5
# VGG11_BN_IMG - MobileNetV2_img
python train_student.py --epochs 100 --lr_decay_epochs 30,60,90 --dataset food101 --num_class 101 --batch_size 64 --learning_rate 0.1 --lr_decay_rate 0.1 --model_t VGG11_BN_IMG --model_s MobileNetV2_img --path_t ./save/base/food101/VGG11_BN_IMG_food101_base/VGG11_BN_IMG_teacher_best.pth.tar --distill fitnet -a 1 -b 1 -r 1 --kd_T 3 -t contrast-4-05_01