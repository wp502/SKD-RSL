...
python train_student.py --epochs 200 --lr_decay_epochs 60,120,160 --dataset caltech256 --num_class 256 --batch_size 64 --dataset_test_percent 0.25 --learning_rate 0.1 --lr_decay_rate 0.1 --model_t VGG11_BN_IMG --model_s MobileNetV2_img --path_t ./save/base/caltech256/VGG11_BN_IMG_caltech256_base/VGG11_BN_IMG_teacher_best.pth.tar --distill kd -a 1 -b 1 -r 1 --kd_T 4 -t contrast-3-05_01