...
python train_student.py --epochs 200 --lr_decay_epochs 60,120,160 --dataset cifar100 --num_class 100 --batch_size 128 --learning_rate 0.1 --lr_decay_rate 0.1 --model_t ResNet101_cifar_another --model_s ResNet34_cifar_another --path_t ./save/base/cifar100/ResNet101_cifar_another_base/ResNet101_cifar_another_teacher_best.pth.tar --distill at -a 1 -b 1 -r 0.9 --kd_T 4 -t contrast-5-02_01

# 3
# VGG13_BN - VGG8_BN
python train_student.py --epochs 200 --lr_decay_epochs 60,120,160 --dataset cifar100 --num_class 100 --batch_size 128 --learning_rate 0.1 --lr_decay_rate 0.1 --model_t VGG13_BN --model_s VGG8_BN --path_t ./save/base/cifar100/VGG13_BN_base/VGG13_BN_teacher_best.pth.tar --distill at -a 1 -b 1 -r 0.9 --kd_T 4 -t contrast-5-03_01
