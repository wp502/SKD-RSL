...
#abla-04_01_02(19-01_29)
python $basicBasic --aux_method_t Basic --aux_method_s Basic -t 19-01_29


python $basicBasic --aux_method_t Basic_big --aux_method_s Basic_big -t abla-04_02_02

python $basicBasic --aux_method_t Bottle --aux_method_s Bottle -t abla-04_03_02

python $basicBasic --aux_method_t Bottle_big --aux_method_s Bottle_big -t abla-04_04_02
