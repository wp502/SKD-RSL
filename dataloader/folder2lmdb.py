...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_dir', type=str, default=None, help='dataset dir path')
    args = parser.parse_args()

    # folder2lmdb("/home/jiang/dataset/imagenet/", name="train")
    # folder2lmdb("/home/jiang/dataset/imagenet/", name="val")
    folder2lmdb(args.dataset_dir, name="train")
    folder2lmdb(args.dataset_dir, name="val")