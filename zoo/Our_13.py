...
__all__ = ["Our_FWD_Conv_13", "Our_FB_Conv_13"]
...
class Our_FWD_Conv_13(nn.Module):
    """ 用于计算 forward 过程中的 中间特征层 的 loss """

    def __init__(self, T, args):
        super(Our_FWD_Conv_13, self).__init__()
        self.T = 1.0
...
class Our_FB_Conv_13(nn.Module):
    """ 用于计算 feedback 过程中的 中间特征层 的 loss """

    def __init__(self, T, args):
        super(Our_FB_Conv_13, self).__init__()
        self.T = 1.0
