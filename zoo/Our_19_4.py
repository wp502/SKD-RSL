...
__all__ = ["Our_FWD_Conv_19_4", "Our_FB_Conv_19_4", "initAUXCFAndAE19_4"]
...
class Our_FWD_Conv_19_4(nn.Module):
    """ 用于计算 forward 过程中的 中间特征层 的 loss """

    def __init__(self, T, args):
        super(Our_FWD_Conv_19_4, self).__init__()
        self.T = 1.0
...
class Our_FB_Conv_19_4(nn.Module):
    """ 用于计算 feedback 过程中的 中间特征层 的 loss """

    def __init__(self, T, args):
        super(Our_FB_Conv_19_4, self).__init__()
        self.T = 1.0
    ...
    def forward(self, feat_t_fb_list, feat_s_fb_list, output_t_fb, output_s_fb, fb_labels, criterion_cls, criterion_div, args):
        ...
        loss_chfb_dict = dict(recon_T_fb=loss_recon_fb_t, loss_fusion=loss_fusion_fb, loss_ce=loss_ce_all, loss_self_kd=loss_kl_all)
